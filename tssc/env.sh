...
export IMAGE_URL=${IMAGE_URL-quay.io/quay_xjiang/backend-tests-go-zlgmqnpd:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/backend-tests-go-zlgmqnpd-gitops
